...
public class ErrorMessages {
	...
	public static final String CANNOT_DRAW_A_CHART_ON_A_NULL_CHART_PANE = "Cannot draw a chart on a null chart pane";
	public static final String CANNOT_DRAW_A_CHART_BASED_ON_NULL_DATA = "Cannot draw a chart based on null data";
